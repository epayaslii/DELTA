...
ROWS = [
    ...
    ("Stage 0 - semantic-guided sampling", "LGTTP",
     ...
     "Its VideoLLM-QA task wrapper", "built (delta.features.sampling, extract --adaptive)"),
    ...
    ("Stage A2 - clips not frames", "HiERO",
     ...
     "Its egocentric narration/Ego4D training pipeline", "backbone-dependent (needs the video encoder)"),
    ...
    ("Baseline - no-evidence floor", "naive-uniform", "", "-", "-", "Baseline",
     ...
     "measured: MoC 0.342 (5-split avg, 19-class, canonical) / 0.366 (split-1, 17-class)"),
