...
# ---- our own plan, condensed to Mert's length/format ----------------------
OURS = [
    ("Input", "Raw video + ordered transcript, no timestamps", "DELTA",
     "Same weak-supervision setup", ""),
    ("Semantic front-end",
     "Encode short clips + transcript actions into a shared space; score clip<->action similarity",
     "OVTAS", "Frozen VLM similarity idea (FAES), keeping transcript order (OVTAS itself discards it)",
     "https://arxiv.org/abs/2602.21406"),
    ("Stage A: coarse alignment",
     "Build the cost (OT + temporal prior) and force actions into transcript order",
     "our ASOT/DP engine + HiERO-StepG principle",
     "Strict monotonic ordered alignment, zero-shot",
     "https://arxiv.org/abs/2605.31227"),
    ...
    ("Stage B2: contrastive refinement",
     ...
     "CVA (principle) -> our PBCR + MASRA LRCA",
