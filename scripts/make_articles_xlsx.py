...
ROWS = [
    ...
    ("Base task + downstream interface", "DELTA", "",
     "DELTA paper (IRI.pdf, internal)", "-", "Core V1",
    ...
    ("Baseline - OT-based TA", "ASOT / CLOT",
     "https://arxiv.org/abs/2404.01518",
     "CVPR 2024 / ICCV 2025", "Xu & Gould / -", "Baseline",
...
OURS = [
    ("Input", "Raw video + ordered transcript, no timestamps", "DELTA",
     "Same weak-supervision setup", ""),
    ("Stage 0: semantic-guided sampling", "Decide where to spend VLM compute using language cues",
     "LGTTP", "Query-driven token density instead of uniform sampling",
     "https://aclanthology.org/2025.emnlp-main.451.pdf"),
    ("Stage A1: semantic front-end",
     "Encode clips + transcript actions into a shared space; score clip<->action similarity",
     "OVTAS", "Frozen VLM similarity (FAES), keeping transcript order (OVTAS itself discards it)",
     "https://arxiv.org/abs/2602.21406"),
    ("Stage A2: video segments", "Represent actions with short multi-scale clips, not single frames",
     "HiERO", "Temporal-context representation over single-frame embeddings",
     "https://openaccess.thecvf.com/content/ICCV2025/papers/Peirone_HiERO_Understanding_the_Hierarchy_of_Human_Behavior_Enhances_Reasoning_on_ICCV_2025_paper.pdf"),
    ("Stage A3: coarse ordered alignment",
     "Force the similarity-based alignment to respect transcript order",
     "HiERO-StepG", "Strict monotonic decode, zero-shot",
     "https://arxiv.org/abs/2605.31227"),
    ("Stage A engine", "Solve the alignment with optimal transport + a temporal prior",
     "ASOT / CLOT", "Fused-GW OT solver (the group's wclot code)",
     "https://arxiv.org/abs/2404.01518 ; https://openaccess.thecvf.com/content/ICCV2025/papers/Bueno-Benito_CLOT_Closed_Loop_Optimal_Transport_for_Unsupervised_Action_Segmentation_ICCV_2025_paper.pdf"),
    ("Stage B1: local boundary search",
     "Search a window around each coarse boundary for the best crossover point",
     "our design", "Explicit, GT-free local semantic boundary localization", ""),
    ("Stage B2: contrastive refinement",
     "Turn confident boundaries into a self-supervised training signal",
     "CVA (principle) -> our PBCR",
     "'A boundary deserves its own contrastive representation' -- rebuilt without GT spans",
     "https://github.com/byeol3325/CVA_cvpr"),
    ("Stage B: relational sharpening",
     "Regularize the frame-similarity matrix toward each action's block structure",
     "MASRA", "LRCA / ESTA train-time regularizers",
     "https://arxiv.org/abs/2605.03398"),
    ("Backbone (all stages)", "Frozen encoder feeding every stage above",
     "VideoLLaMA3", "Vision tower for similarity; chat model for captions/reasoning",
     "https://arxiv.org/abs/2501.13106"),
    ("Optional Stage C", "Iteratively refine frame/segment representations if boundaries stay noisy",
     "CLOT / D-CLOT", "Closed-loop prototype re-estimation, ambiguous-transition focus",
     "https://arxiv.org/abs/2608.05877"),
    ("Optional Stage D", "Call an expensive VLM only on the hardest boundaries",
     "TOGA / VideoLLaMA3", "Segment-prompted reasoning, used selectively",
     "https://arxiv.org/abs/2506.09445"),
    ("Stage A alternative (ablation)",
     "Replace the DP/OT decode with a full multimodal-OT decoder",
     "TASOT", "Visual + semantic + temporal cost fused in one OT problem",
     "https://arxiv.org/abs/2602.24138"),
    ("Output", "Convert refined boundaries into dense per-frame pseudo-labels Y*",
     "DELTA", "Preserve the existing downstream decoder interface", ""),
    ("Baseline: no-evidence floor", "Split the video into equal parts, in transcript order",
     "-", "Comparison number only (MoC 0.366)", ""),
    ("Baseline: classifier-based TA", "Frame classifier + boundary-aware DP",
     "ATBA", "Comparison number only",
     "https://arxiv.org/abs/2403.19225"),
    ("Baseline: OT-based TA", "ASOT/CLOT trained as a standalone segmenter",
     "ASOT / CLOT", "Comparison number only",
     "https://arxiv.org/abs/2404.01518"),
    ("Baseline: segmentation SOTA (cite)", "ATBA + a VAE regularizer",
     "HAL", "Breakfast number, cited not run",
     "https://arxiv.org/abs/2602.24275"),
    ("Citation: paradigm", "MLLM guides a weak model at training time only",
     "MLLM4WTAL", "Paradigm citation",
     "https://arxiv.org/abs/2411.08466"),
    ("Citation: aligner mechanism", "Ordered sequence -> video alignment, pre-VLM",
     "StepFormer / TAN / Drop-DTW", "Background citations",
     "https://arxiv.org/abs/2304.13265 ; https://arxiv.org/abs/2204.02968 ; https://arxiv.org/abs/2108.11996"),
    ("Citation: joint align+seg", "Single OT model for video-video alignment + segmentation",
     "VAOT / VASOT", "Background citation",
     "https://arxiv.org/abs/2503.16832"),
]
